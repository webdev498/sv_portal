				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<!-- page-title start -->
							<!-- ================ -->
							<h1 class="page-title">SARKU JAPAN: Required Activation Steps
									...
									<div class="col-sm-6 col-md-4 col-lg-6">
										<div class="body">
											...
											<OL>
												...
												<LI>Plug the Panasonic charging cradle in at the HOST STAND and place the handset in the charger. A red light should appear and the phone should beep to indicate it is charging. To turn the handset on, press and hold the red power button. The phone will upgrade its firmware and reboot automatically.<BR></LI>
											...
											<OL>
												<LI>Plug the 2nd Panasonic charging cradle in at the HOST STAND and place the handset in the charger. A red light should appear and the phone should beep to indicate it is charging. To turn the handset on, press and hold the red power button. The screen should say "Register Handset".<BR></LI>
												<LI>To pair this handset, press and hold the button on the Panasonic base station for 5 seconds until the red light flashes. On the handset, press and hold the OK button to register this handset to the base station. After 3 seconds it will produce a long beep and the screen should come up with the time like the other handset and say <b>Handset 2</b>. Once paired, this handset will download and upgrade its firmware. This process takes 5 minutes.<BR></LI>
											...
											<h4>Complete Test Calls (complete all tests on ALL handsets):</h4>
							...
							<div id=testmessage><B>Performing Broadband Tests...THIS WILL TAKE UP TO 5 MINUTES...</B><i class="fa fa-refresh fa-spin" style="font-size:24px"></i></div><BR> 
