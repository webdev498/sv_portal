				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<!-- page-title start -->
							<!-- ================ -->
							<h1 class="page-title">LOGAN'S ROADHOUSE: Required Activation Steps
								...
								<div class="row">
									<div class="col-sm-6 col-md-4 col-lg-3">
										<div class="overlay-container overlay-visible">
											<img src="images/t27p.jpg" alt="">
											<div class="overlay-bottom hidden-xs">
												<div class="text">
													<p class="small margin-clear"><em>Yealink T27P</em></p>
												</div>
											</div>
										</div>
									</div>
									<div class="col-sm-6 col-md-4 col-lg-6">
										<div class="body">
											<h3 class="title margin-clear">Yealink T27P - BAR PHONE</h3>
											<div class="separator-2 mt-10"></div>
											<p>Unbox the Yealink T27P desk phone, assemble and connect the INTERNET port on the phone to the port labeled <b>Phone</b> on the Ethernet wall plate. Place the Yealink T27P next to the existing phone at the BAR and wait for it to power on and download its config completely. The phone should boot up, download its config and show the extension along with  phone icons for the 3 line buttons 1, 2 and 3.</p>
											...
											<h3 class="title margin-clear">Yealink T27P - HOST STAND PHONE</h3>
											<div class="separator-2 mt-10"></div>
											<p>Unbox the Yealink T27P desk phone, assemble and connect the INTERNET port on the phone to the port labeled <b>1 Phone</b> on the Ethernet wall plate. Place the Yealink T27P next to the existing phone at the HOST STAND and wait for it to power on and download its config completely. The phone should boot up, download its config and show the extension along with  phone icons for the 3 line buttons 1, 2 and 3.</p>
									...
									<div class="col-sm-12 col-md-4 col-lg-3">
										<div class="overlay-container overlay-visible">
											<img src="customerimages/t27p-complete-logans.jpg" alt="">
											<div class="overlay-bottom hidden-xs">
												<div class="text">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4 col-lg-6">
										<div class="body">
											...
											<div class="separator-2 mt-10"></div>
											<OL>
												<LI>Plug the Panasonic TGP-600 base station Ethernet into switch <B>port 7 on the Meraki MS220</B> and place the Panasonic base unit in a safe, visible location. Do not use the included power adapter - this device is PoE. Do not place this inside a cabinet or near any computers or PC monitors. <b>After 3-5 minutes you should see a solid green light. A flashing orange light indicates an IP issue (no internet generally). </b><BR></LI>		
												<LI>Plug the Panasonic charging cradle in at the cash wrap and place the handset in the charger. A red light should appear and the phone should beep to indicate it is charging. To turn the handset on, press and hold the red power button. The phone will upgrade its firmware and reboot automatically.<BR></LI>
							...
							<div class="image-box team-member style-3-b">
								<div class="row">
									<div class="col-sm-6 col-md-4 col-lg-3">
										<div class="overlay-container overlay-visible">
											<img src="images/kyocera-duramax.jpg" alt="">
											<div class="overlay-bottom hidden-xs">
												<div class="text">
													<p class="small margin-clear"><em>Kyocera DuraMax Cell Phone - OFFICE/BACKUP</em></p>
												</div>
											</div>
										</div>
									</div>
									<div class="col-sm-6 col-md-4 col-lg-6">
										<div class="body">
											<h3 class="title margin-clear">Kyocera DuraMax Cell Phone</h3>
											<div class="separator-2 mt-10"></div>
											<OL>
												<LI>This cell phone is already activated and tested. Unbox the phone, plug the charger in and connect the phone to the charger.<BR></LI>		
												<LI>Power on the phone, verify there is adequate service in the restaurant and place a test call to your cell phone.<BR></LI>
												
											</OL>
											<div id="testcall_4"><button id=testcall4 disabled type=button class='btn radius-10 btn-success btn-lg' onclick="completeTestCall(4)">Testing Complete</button></div>
