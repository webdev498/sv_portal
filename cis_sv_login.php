...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>SimpleVoIP/CIS - Login</title>
				...
				<div class="container">
					<div class="object-non-visible text-center" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
						...
						<div class="form-block center-block p-30 light-gray-bg border-clear">
							...
							<h2 class="title text-left">SimpleVoIP/CIS Login</h2>
						
							<form action="cis_sv_login.php" class="form-horizontal text-left" method=get>
