...
if ($useAJAX) {
	...
	$includes.="var INLINE_EDIT_TABLE='comments_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='comments_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='comments_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='comments_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='comments_masterpreview.php';\r\n";
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='comments_list.php?goto='+nPageNumber;
		}
</script>");
...
//	include proper masterlist.php code
	include("include/articles_masterlist.php");
	$masterkeys[]=@$_SESSION[$strTableName."_masterkey1"];
	DisplayMasterTableInfo("comments", $masterkeys);
	$smarty->assign("showmasterfile","articles_masterlist.htm");
}
...
$templatefile = "comments_list.htm";
