...
"var SUGGEST_LOOKUP_TABLE='article_lookupsuggest.php';\r\n".
"var AUTOCOMPLETE_TABLE=\"article_autocomplete.php\";\r\n";
}
...
$(document).ready(function() {
	...
	document.forms.editform.value_screenp.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_screenp,'advanced')};
	document.forms.editform.value1_screenp.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_screenp,'advanced1')};
	document.forms.editform.value_screenp.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_screenp,'advanced')};
	document.forms.editform.value1_screenp.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_screenp,'advanced1')};
	document.forms.editform.value_screens.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_screens,'advanced')};
	document.forms.editform.value1_screens.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_screens,'advanced1')};
	document.forms.editform.value_screens.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_screens,'advanced')};
	document.forms.editform.value1_screens.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_screens,'advanced1')};
});
</script>
...
//	edit format
$editformats["screenp"]="Text field";
// filep 
$opt="";
$not=false;
if(@$_SESSION[$strTableName."_search"]==2)
...
//	edit format
$editformats["screens"]="Text field";
// files 
$opt="";
$not=false;
if(@$_SESSION[$strTableName."_search"]==2)
...
$templatefile = "article_search.htm";
