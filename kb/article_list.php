...
if ($useAJAX) {
	...
	$includes.="var INLINE_EDIT_TABLE='article_edit.php';\r\n";
	$includes.="var INLINE_ADD_TABLE='article_add.php';\r\n";
	$includes.="var INLINE_VIEW_TABLE='article_view.php';\r\n";
	$includes.="var SUGGEST_TABLE='article_searchsuggest.php';\r\n";
	$includes.="var MASTER_PREVIEW_TABLE='article_masterpreview.php';\r\n";
...
$smarty->assign("pagination","<script language=\"JavaScript\">WritePagination(".$mypage.",".$maxpages.");
		...
		{
			window.location='article_list.php?goto='+nPageNumber;
		}
</script>");
...
//	key fields
			...
			$row[$col."recno"] = $recno;
//	detail tables
			$masterquery="mastertable=article";
			$masterquery.="&masterkey1=".rawurlencode($data["ArticleID"]);
			$row[$col."comment_masterkeys"]=$masterquery;
//	edit page link
			$editlink="";
...
$strPerm = GetUserPermissions("comment");
$smarty->assign("allow_comment",!(strpos($strPerm, "A")===false && strpos($strPerm, "S")===false));
